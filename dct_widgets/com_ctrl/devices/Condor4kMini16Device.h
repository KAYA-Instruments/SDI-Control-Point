 ...
 *****************************************************************************/
/**
 * @file    Condor4kMini16Device.h
 *
 * @brief   
 *
 *****************************************************************************/
#ifndef _CONDOR4K_MINI16_DEVICE_H_
#define _CONDOR4K_MINI16_DEVICE_H_

#include <QObject>

#include "ProVideoDevice.h"

class Condor4kMini16Device : public ProVideoDevice
{
public:
    explicit Condor4kMini16Device( ComChannel * c, ComProtocol * p );
    Condor4kMini16Device( const ProVideoDevice &baseObj );
    ~Condor4kMini16Device();
...
#endif // _CONDOR4K_MINI16_DEVICE_H_
