 ...
 *****************************************************************************/
/**
 * @file    Condor4kMini11Device.h
 *
 * @brief   
 *
 *****************************************************************************/
#ifndef _CONDOR4K_MINI11_DEVICE_H_
#define _CONDOR4K_MINI11_DEVICE_H_

#include <QObject>

#include "ProVideoDevice.h"

class Condor4kMini11Device : public ProVideoDevice
{
public:
    explicit Condor4kMini11Device( ComChannel * c, ComProtocol * p );
    Condor4kMini11Device( const ProVideoDevice &baseObj );
    ~Condor4kMini11Device();
...
#endif // _CONDOR4K_MINI11_DEVICE_H_
