 ...
 *****************************************************************************/
/**
 * @file    Condor4kMini07Device.h
 *
 * @brief   
 *
 *****************************************************************************/
#ifndef _CONDOR4K_MINI07_DEVICE_H_
#define _CONDOR4K_MINI07_DEVICE_H_

#include <QObject>

#include "ProVideoDevice.h"

class Condor4kMini07Device : public ProVideoDevice
{
public:
    explicit Condor4kMini07Device( ComChannel * c, ComProtocol * p );
    Condor4kMini07Device( const ProVideoDevice &baseObj );
    ~Condor4kMini07Device();
...
#endif // _CONDOR4K_MINI07_DEVICE_H_
