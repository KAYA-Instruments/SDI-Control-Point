...
Component.prototype.installerLoaded = function()
{
    ...
    installer.addWizardPage(component, "ShortcutWidget", QInstaller.ReadyForInstallation);
    ...
    shortcutPage = gui.pageWidgetByObjectName("DynamicShortcutWidget");
    shortcutPage.windowTitle = "Desktop Shortcut";
    shortcutPage.description.setText("Please select whether you want to add a desktop shortcut:");
...
function instsllDesktopShortcut()
{
    if (component.userInterface( "ShortcutWidget" ).DesktopShortcut.checked == true)
    {
        // Following example from: https://forum.qt.io/topic/38166/qt-installer-framework-create-shortcut-on-the-desktop/3
        if (installer.value("os") === "win")
        {
            component.addOperation("CreateShortcut", "@TargetDir@/SDIControlPoint.exe", "@DesktopDir@/SDIControlPoint.lnk");
        }
